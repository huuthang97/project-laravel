								...
								<tbody>
									...
									<tr>
											...
											<td>
												...
												<a  href="{{ asset('admin/product/delete/'.$product->id) }}" onclick="return confirm('Bạn có chắc chắn xóa?')" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
											</td>
										</tr>
									@endforeach
								</tbody>
